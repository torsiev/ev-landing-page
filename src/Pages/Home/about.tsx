    ...
    return (
        <div className="container mx-auto max-w-screen-lg my-auto px-4">
            <div className="mt-5 flex flex-row md:gap-10 justify-center mb-5 items-center">
                ...
                <h1 className="text-2xl md:text-3xl mt-5 font-bold text-sky-500 text-center">About</h1>
                <Image className="h-2 md:h-10 mt-5" src={right} alt="line-right"  />
            </div>
            <div className="flex flex-col lg:flex-row-reverse gap-5 lg:gap-32">
                <Image className="max-w-full rounded-md lg:max-w-md lg:rounded-md object-contain aspect-auto " src={konversi} alt="konversi" />
            ...
            <div>
                <button className="btn mt-5 bg-transparent border-2 border-sky-500 text-sky-500 w-40 md:w-60 hover:bg-sky-500 hover:text-white hover:border-none">See More</button>
            </div>
        </div>
    )
}