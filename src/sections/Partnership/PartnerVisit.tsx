            ...
            <div className="max-w-screen-xl justify-items-center">
              <div className="flex flex-col md:flex-row gap-3">
                <div className="relative group">
                  <Image
                    src={pict1}
                    className="size-auto rounded-md"
                    alt="pict1"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    ...
                    Uji coba penggunaan charging station Torsi EV -
                ...
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                      Kunjungan mitra powerindo: Uji coba performa Stroom! dengan
                      pemeriksaan respons throttle - Rabu, 04 Oktober 2023
                    </p>
                  </div>
                </div>
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                    Kunjungan mitra powerindo: Kunjungan lokasi bengkel Torsi EV - Rabu, 04 Oktober 2023
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-screen-xl justify-items-center">
              <div className="flex flex-col md:flex-row gap-3">
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                      Foto bersama jajaran Torsi EV bersama mitra Powerindo - Rabu, 04 Oktober 2023
                    </p>
                  </div>
                </div>
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                    Suasana rapat diskusi kerja sama bersama mitra Powerindo - Rabu, 04 Oktober 2023
                    </p>
                  </div>
                </div>
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                    Penjelasan sistem kerja motor konversi Torsi EV kepada mitra Powerindo - Rabu, 04 Oktober 2023
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-screen-xl justify-items-center">
              <div className="flex flex-col md:flex-row gap-3">
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                      Foto bersama jajaran Torsi EV dan mahasiswa FIT bersama mitra XXX - Jumat, 20 Oktober 2023
                    </p>
                  </div>
                </div>
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                     Pemasangan Charging Point di TULT bersama mitra XXX - Jumat, 20 Oktober 2023
                    </p>
                  </div>
                </div>
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity rounded-md">
                    <p className="text-white text-center p-10">
                      Perakitan komponen Charging Point di TULT bersama mitra XXX - Jumat, 20 Oktober 2023
                    </p>
                  </div>
                </div>
              </div>
