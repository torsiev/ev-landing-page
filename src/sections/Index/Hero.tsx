      ...
      <div className="hero min-h-screen">
        ...
        <div className="hero-content text-neutral-content text-center p-4 md:p-8">
          <div className="max-w-lg md:max-w-2xl lg:max-w-4xl">
            <h1 className="mb-3 text-2xl md:text-5xl font-bold text-white">Welcome to Torsi EV</h1>
            ...
            <button className="btn rounded-md pl-9 pr-9 h-15 bg-transparent border-white border-[3px] text-white hover:bg-white hover:text-sky-500 hover:border-none">GET STARTED</button>
          </div>
        </div>
      </div>
