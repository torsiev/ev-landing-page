...
export default function Services() {
  ...
  return (
    ...
    <div className="container mx-auto max-w-screen-xl my-auto px-4 md:mt-0">
      <div className="mt-5 flex flex-row gap-10 justify-center mb-5 items-center" data-aos="zoom-in">
      ...
      <div className="flex flex-col lg:flex-row gap-9 place-items-center mt-12">
        ...
        <div className="card bg-white w-full shadow-md text-black hover:shadow-xl" data-aos="fade-down" data-aos-duration="400">
        ...
        <div className="card bg-white w-full shadow-md text-black hover:shadow-xl" data-aos="fade-down" data-aos-duration="1000">
          <figure className="px-5 pt-5">
        ...
        <div className="card bg-white w-full shadow-md text-black hover:shadow-xl" data-aos="fade-down" data-aos-duration="1600">
          <figure className="px-5 pt-5">
