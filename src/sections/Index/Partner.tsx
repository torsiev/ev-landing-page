...
export default function Partner() {
    ...
    return (
        ...
        <section className="mt-5">
            ...
            <div className="flex flex-row md:gap-10 justify-center mb-5 items-center" data-aos="zoom-in">
            <Image className="h-2 md:h-10 mt-5" src={left} alt="line-left" />
                <h1 className="text-3xl md:text-4xl mt-5 font-bold text-sky-500 text-center">Partnership</h1>
